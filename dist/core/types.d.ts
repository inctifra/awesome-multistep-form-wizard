...
export type ValidationResult = ValidationSuccess | ValidationFailure | ValidationAborted;
...
export type Validator<TValues = Record<string, unknown>> = (context: ValidationContext<TValues>) => ValidationResult | Promise<ValidationResult>;
...
export type ValidationSource = "schema" | "custom" | "backend" | "vest" | "system";
